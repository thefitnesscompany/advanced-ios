...
class CameraManager: ObservableObject {
    ...
    private let sessionQueue = DispatchQueue(label: "com.advanced.advanced-ios")
        ...
        if status == .configured {
            ...
            DispatchQueue.main.async {
                self.alertError = AlertError(
                    ...
                    primaryButtonTitle: "ok", secondaryButtonTitle: nil, primaryAction: nil, secondaryAction: nil
                )
    ...
    func captureImage() {
        sessionQueue.async { [weak self] in
            ...
            if self.videoDeviceInput != nil && self.videoDeviceInput!.device.isFlashAvailable {
